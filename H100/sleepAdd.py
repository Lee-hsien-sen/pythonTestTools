...
from H100 import token, month1, day1, month2, day2, sever_dev
...
class SleepTime:
    ...
    def sleepAdd(self, host=sever_dev, num_intervals=2, time_offset_hours=4, max_workers=10):
        random_intervals = generate_random_intervals(start_time, end_time, num_intervals, time_offset_hours)
        self.url = host + '/greencode/ihealth/sleep/add'
